...
<body class="bg-gray-100">
  ...
  <div class="max-w-4xl mx-auto p-6">
    ...
    <!-- Formulario -->
    <form action='/todos' method="POST" class="bg-white p-6 rounded-lg shadow-lg space-y-6">
        @csrf
      <!-- Campo de nombre -->
      <div>
      ...
      <!-- Campo de descripción -->
        ...
        <textarea name="desc" id="desc" rows="4" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required></textarea>
        </div>
      ...
      <div>
        ...
        <input type="datetime-local" name="due_date" id="due_date" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
      </div>

      <!-- Botón de submit -->
      <div class="flex justify-between items-center">
        <button type="submit" class="bg-blue-500 text-black px-6 py-3 rounded-md hover:bg-blue-600">Crear Tarea</button>
